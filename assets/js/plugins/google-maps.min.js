...
icon:r,position:e,map:g});var h=null;jQuery(window).resize(function(){h&&clearTimeout(h);h=setTimeout(function(){g.setCenter(e)},200)})}else console.log("Google Maps: Geocode was not successful for the following reason: "+k)})}jQuery(function(){jQuery(".fugu-gmap").each(function(){initGmap(jQuery(this))})});