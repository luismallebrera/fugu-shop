...
var nmBlocksAddClassName = function(props, blockType, attributes) {
    ...
    if (blockType.name === 'core/heading') {
        return Object.assign(props, { className: notDefined ? 'fugu-block-heading' : 'fugu-block-heading ' + props.className });
    }
    
    if (blockType.name === 'core/list') {
        return Object.assign(props, {
            className: notDefined ? 'fugu-block-list' : 'fugu-block-list ' + props.className
        });
    }
    
    return props;
}
wp.hooks.addFilter('blocks.getSaveContent.extraProps', 'fugu-theme/blocks-add-class-name', nmBlocksAddClassName); // Hook