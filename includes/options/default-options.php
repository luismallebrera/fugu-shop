<?php
	 ...
	 *	
	 *	Note: To re-generate default options use "var_export($fugu_theme_options)" on -unchanged- options
	 */
	...
	$default_options = array (
		...
		'menu_login_popup' => 0,
		'menu_login_icon' => 0,
        'menu_login_icon_html' => '<i class="fugu-myaccount-icon fugu-font fugu-font-head"></i>',
		'menu_cart' => '1',
		'menu_cart_icon' => 1,
        'menu_cart_icon_html' => '<i class="fugu-menu-cart-icon fugu-font fugu-font-cart"></i>',
        ...
        'cart_shipping_meter_message' => __( 'Spend {remaining} more to get FREE SHIPPING', 'fugu-framework-admin' ),
        'cart_shipping_meter_message_qualified' => __( 'This order gets FREE SHIPPING!', 'fugu-framework-admin' ),
        ...
        'menu_wishlist_icon_html' => '<i class="fugu-font fugu-font-heart-outline"></i>',
        ...
        'portfolio_category_permalink' => 'portfolio_category',
	...
	$fugu_theme_options = $default_options;
	
	// Save default options to the database
	update_option( 'fugu_theme_options', $default_options );
