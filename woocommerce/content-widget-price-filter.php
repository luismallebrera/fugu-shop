 ...
 * @version 7.0.1
 NM: Modified - Added ".fugu-price-slider-label" element and moved "button" element */
	...
	<div class="price_slider_wrapper">
		...
		<div class="price_slider_amount" data-step="<?php echo esc_attr( $step ); ?>">
			...
			<div class="price_label" style="display:none;">
                <div class="fugu-price-slider-label"><?php echo esc_html__( 'Price:', 'woocommerce' ); ?> </div><span class="from"></span> &mdash; <span class="to"></span>
			</div>
