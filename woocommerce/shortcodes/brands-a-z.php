...
$show_empty = apply_filters( 'fugu_brands_list_show_empty', false );
$fugu_index_title = apply_filters( 'fugu_brands_list_index_title', '<i class="fugu-font fugu-font-menu"></i>' );
?>
<div id="brands_a_z">

	<ul class="brands_index">
        <li class="current-index"><a href="#all"><?php echo wp_kses_post( $fugu_index_title ); ?></a></li>
		<?php
		foreach ( $index as $i ) {
