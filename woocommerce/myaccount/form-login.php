...
if ( isset( $is_popup ) ) {
	...
	$popup_redirect_url = esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) . '?fugu_popup_login=1' );
	$popup_redirect_input = sprintf( '<input type="hidden" class="fugu-login-popup-redirect-input" name="redirect" value="%s" />', $popup_redirect_url );
...
<div id="customer_login" class="fugu-myaccount-login">
    <div class="fugu-myaccount-login-inner">
		
        <div id="fugu-login-wrap">
            ...
            <form<?php echo $popup_form_action_escaped; ?> class="login" method="post" novalidate>
                ...
                <p class="form-actions">
                    ...
                    <div class="fugu-login-form-divider"><span><?php esc_html_e( 'Or', 'fugu-framework' ); ?></span></div>
                    
                    <a href="#register" id="fugu-show-register-button" class="button border"><?php esc_html_e( 'Create an account', 'fugu-framework' );//esc_html_e( 'Register', 'woocommerce' ); ?></a>
                    <?php endif; ?>
                </p>
        ...
        <div id="fugu-register-wrap">
            ...
            <form<?php echo $popup_form_action_escaped; ?> method="post" class="register" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
                ...
                <p class="form-actions">
                    ...
                    <a href="#login" id="fugu-show-login-button" class="button border"><?php esc_html_e( 'Log in', 'woocommerce' ); ?></a>
                    <?php endif; ?>
                </p>
